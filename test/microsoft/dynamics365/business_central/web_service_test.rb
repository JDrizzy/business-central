...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/web_service_test.rb

class Microsoft::Dynamics365::BusinessCentral::WebServiceTest < Minitest::Test
  def setup
    @client = Microsoft::Dynamics365::BusinessCentral::Client.new
    @web_service = Microsoft::Dynamics365::BusinessCentral::WebService.new(client: @client)
  end
