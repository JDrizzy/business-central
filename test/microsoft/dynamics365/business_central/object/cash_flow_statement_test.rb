...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/object/cash_flow_statement_test.rb

class Microsoft::Dynamics365::BusinessCentral::Object::CashFlowStatementTest < Minitest::Test
  def setup
    @company_id = '123456'
