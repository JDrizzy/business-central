...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/object/customer_payment_journal_test.rb

class Microsoft::Dynamics365::BusinessCentral::Object::CustomerPaymentJournalTest < Minitest::Test
  def setup
    @company_id = '123456'
