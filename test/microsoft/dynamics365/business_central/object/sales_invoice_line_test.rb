...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/object/sales_invoice_line_test.rb

class Microsoft::Dynamics365::BusinessCentral::Object::SalesInvoiceLineTest < Minitest::Test
  def setup
    @company_id = '123456'
  ...
  def test_invalid_sales_invoice_line_parent
    assert_raises(Microsoft::Dynamics365::BusinessCentral::InvalidArgumentException) do
