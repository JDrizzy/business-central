...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/object/filter_query_test.rb

class Microsoft::Dynamics365::BusinessCentral::Object::FilterQueryTest < Minitest::Test
  def setup
    @filter_query = Microsoft::Dynamics365::BusinessCentral::Object::FilterQuery
  end
