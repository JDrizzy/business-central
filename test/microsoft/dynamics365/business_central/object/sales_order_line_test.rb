...
require 'test_helper'
# rake test TEST=test/microsoft/dynamics365/business_central/object/sales_order_line_test.rb

class Microsoft::Dynamics365::BusinessCentral::Object::SalesOrderLineTest < Minitest::Test
  def setup
    @company_id = '123456'
  ...
  def test_find_all
    stub_request(:get, /salesOrderLines/)
      .to_return(
        status: 200,
        body: {
          'value': [
  ...
  def test_find_by_id
    test_id = '09876'
    stub_request(:get, /salesOrderLines\(#{test_id}\)/)
      .to_return(
        status: 200,
        body: {
          id: test_id,
  ...
  def test_where
    ...
    stub_request(:get, /salesOrderLines\?\$filter=#{test_filter}/)
      .to_return(
        status: 200,
        body: {
          'value': [
  ...
  def test_create
    stub_request(:post, /salesOrderLines/)
      .to_return(
        status: 200,
        body: {
          id: '678',
  ...
  def test_update
    ...
    stub_request(:patch, /salesOrderLines\(#{test_id}\)/)
      .to_return(
        status: 200,
        body: {
          id: test_id,
  ...
  def test_delete
    ...
    stub_request(:delete, /salesOrderLines\(#{test_id}\)/)
